...
@#$#@#$#@
Title: Ant System
Author: Chistopher Roach and Benito Mendoza
Description:
This model is an implementation of the Ant System algorithm, as described in [<a href="http://citeseer.ist.psu.edu/dorigo96ant.html">1</a>], that is being used to solve the Traveling Salesman Problem.
